...
public class RestApiControllerTest {
    ...
    void productsCreate() throws Exception {
        ...
        // curl -X POST -H 'Content-Type: application/json' -d '{"customer": "custo9" , "histories":[{"name":"ftko","qty":"345","price":"980"}, {"name":"1","qty":"900","price":"10"} ]}' http://localhost:8080/api/derivery/register
    }
}
